...
public class Activity {
    ...
    public Activity(String type, String id, String name, Date date) {
        this.type = type;
        this.id = id;
        this.name = name;
        this.date = date;
    ...
    public String getActivityInfo() {
        String info = "Name: " +  this.name + "Type: " +  this.type +" -- Date: " + this.date + " -- " + " -- # of points: " + this.dataPoints.size();
        return info;
    }
    ...
    public Gps getStartPosition() {
        return startPosition;
    }

    public Gps getEndPosition() {
        return endPosition;
    }
    ...
    public void setAvgHeartRate() {
        this.avgHeartRate = getAvgHeartRate();
    }

    public void setStartPosition(Gps startPosition) {
        this.startPosition = startPosition;
    }

    public void setEndPosition(Gps endPosition) {
